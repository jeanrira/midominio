...
<head>
    ...
    <title>Consulta de Avisos Pendientes de Cobro</title>
</head>
<body>
<?php
    echo "<h1>Consulta de Avisos Pendientes de Cobro</h1>";
    ...
    $sentencia = "select * from tbavisos where estado = 4 order by fechaaviso;";
    ...
    echo "<br/><h3><a href='consultaavisos0.php'>Mostrar solo no atendidos</a>  <a href='consultaavisos123.php'>Mostrar atendidos y no terminados</a>    <a href='consultaavisos.php'>Mostrar todo el listado</a></h3>";
