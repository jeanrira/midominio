...
<?php
    ...
    if (!isset($_GET['id'])) {
        ...
        $sentencia = "select * from tbavisos where id=1;";
        ...
        if ($fila = mysqli_fetch_array($consultar)) {
            ...
            $estado = $fila['estado'];
            $html = '<h1>ATEDNER AVISO $id</h1><br/><br/>
            ...
            <br/>
            <p>Codigos de estado: 0 - No atendido, 1,2,3  - Atendido y no terminado, 4 - Pendiente de Cobro</p>
            <br/>
