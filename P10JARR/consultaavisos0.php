...
<head>
    ...
    <title>Consulta de Avisos No Atendidos</title>
</head>
<body>
<?php
    echo "<h1>Consulta de Avisos No Atendidos</h1>";
    ...
    $sentencia = "select * from tbavisos where estado = 0 order by fechaaviso;";
    ...
    echo "<br/><h3><a href='consultaavisos.php'>Mostrar todo el listado</a>  <a href='consultaavisos123.php'>Mostrar atendidos y no terminados</a>    <a href='consultaavisos4.php'>Mostar pendientes de cobro</a></h3>";
